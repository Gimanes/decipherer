...
binary = {
    ...
    "8": "00111000", "9": "00111001", " ": "00100000", "!": "00100001",
    "\"": "00100010", "#": "00100011", "$": "00100100", "%": "00100101",
    "&": "00100110", "'": "00100111", "(": "00101000", ")": "00101001",
    "*": "00101010", "+": "00101011", ",": "00101100", "-": "00101101",
    ".": "00101110", "/": "00101111", ":": "00111010", ";": "00111011",
    "<": "00111100", "=": "00111101", ">": "00111110", "?": "00111111",
    "@": "01000000", "[": "01011011", "\\": "01011100", "]": "01011101",
    "^": "01011110", "_": "01011111", "`": "01100000", "{": "01111011",
...
def encode(text: str):
    ...
    for char in text:
        if char in binary:
            translation += binary[char]
        else:
            translation += char
    if main.log_on:
        with open("log.txt", "a") as f:
            f.write(f"Action: Binary Encode - Text: {text}\n")
...
def decode(text: str):
    ...
    if main.log_on:
        with open("log.txt", "a") as f:
            f.write(f"Action: Binary Decode - Text: {text}\n")
